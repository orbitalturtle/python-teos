...
_GETSUBSCRIPTIONINFOREQUEST = _descriptor.Descriptor(
    name="GetSubscriptionInfoRequest",
    full_name="teos.protobuf.protos.v1.GetSubscriptionInfoRequest",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            name="signature",
            full_name="teos.protobuf.protos.v1.GetSubscriptionInfoRequest.signature",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
DESCRIPTOR.message_types_by_name["GetSubscriptionInfoRequest"] = _GETSUBSCRIPTIONINFOREQUEST
...
GetSubscriptionInfoRequest = _reflection.GeneratedProtocolMessageType(
    "GetSubscriptionInfoRequest",
    (_message.Message,),
    {
        "DESCRIPTOR": _GETSUBSCRIPTIONINFOREQUEST,
        "__module__": "user_pb2"
        # @@protoc_insertion_point(class_scope:teos.protobuf.protos.v1.GetSubscriptionInfoRequest)
    },
)
_sym_db.RegisterMessage(GetSubscriptionInfoRequest)
